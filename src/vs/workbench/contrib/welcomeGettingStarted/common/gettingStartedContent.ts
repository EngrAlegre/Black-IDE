...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: 'Setup',
		title: localize('gettingStarted.setup.title', "Get started with Black IDE"),
	...
	{
		id: 'SetupWeb',
		title: localize('gettingStarted.setupWeb.title', "Get started with Black IDE for the Web"),
